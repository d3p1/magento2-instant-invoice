...
A [Magento 2](https://business.adobe.com/products/magento/magento-commerce.html) development that makes the implementation of an instant invoice flow easier.
